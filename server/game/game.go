...
func NewGame(id int) Game {
	return &game{
		...
		Field: [][]Figure{
			...
			{newPawn(6, 0, Black), newPawn(6, 1, Black), newPawn(6, 2, Black), newPawn(6, 3, Black), newPawn(6, 4, Black), newPawn(6, 5, Black), newPawn(6, 6, Black), newPawn(1, 7, Black)},
			{newRook(7, 0, Black), newKnight(7, 1, Black), newBishop(7, 2, Black), newKing(7, 4, Black), newQueen(7, 3, Black), newBishop(7, 5, Black), newKnight(7, 6, Black), newRook(0, 7, Black)},
		},
	}
}
